...
# Titre principal
st.title("🏷️ Analyse des Tags des Films")
st.markdown("Explorez les tags les plus utilisés, leur relation avec les évaluations, et leur répartition par genre.")
...
fig_compare_tags = px.bar(
    ...
    color="Type",
    barmode="group",
    title="⚖️ Comparaison des Tags : Films bien vs mal notés",
    labels={"count": "Occurrences", "tag": "Tag"},
    height=500
)
fig_compare_tags.update_layout(yaxis={'categoryorder': 'total ascending'})
...
# ========== Affichage en 3 colonnes ==========
st.markdown("### 🔎 Vue générale des tags")
col1, col2, col3 = st.columns(3)
with col1:
    st.plotly_chart(fig_user_tags, use_container_width=True)
with col2:
